...
//   coin_name             coin_shortcut  address_type  maxfee_kb          p2sh        p2wpkh     p2wsh      signed_message_header                           bip44_account_path  forkid     decimals    contract_address  gas_limit         xpub_magic       xprv_magic       segwit        force_bip143  curve_name               cashaddr_prefix       bech32_prefix  decred         version_group_id  xpub_magic_segwit_p2sh  xpub_mmagic_segwit_native
    ...
    {true, ETHEREUM,       true, "ETH",   true,  NA,    true,     100000,  true,  NA,  false, 0,  false, 0,  true, "\x19" "Ethereum Signed Message:\n",      true, 0x8000003c,   false, 0,  true,  18,  false, {0, {0}},  false, {0, {0}},  false, 0,        false, 0,        true, false,  true, false,  true, SECP256K1_STRING,  false, "",            false, "",     false, false,  false, 0,         false,        0,        false,       0 },
    {true, ETHEREUM_CLS,   true, "ETC",   true,  NA,    true,     100000,  true,  NA,  false, 0,  false, 0,  true, "\x19" "Ethereum Signed Message:\n",      true, 0x8000003d,   false, 0,  true,  18,  false, {0, {0}},  false, {0, {0}},  false, 0,        false, 0,        true, false,  true, false,  true, SECP256K1_STRING,  false, "",            false, "",     false, false,  false, 0,         false,        0,        false,       0 },
    ...
    {true, "Pesetacoin",   true, "PTC",   true,  47,    true, 1000000000,  true,  22,  false, 0,  false, 0,  true, "\x19" "Pesetacoin Signed Message:\n",    true, [[[x800]]],   false, 0,  true,   8,  false, {0, {0}},  false, {0, {0}},  true, 76071982,  true, 76079604,  true, false,  true, false,  true, SECP256K1_STRING,  false, "",            false, "",     false, false,  false, 0,         false,        0,        false,       0 },
